...
Jumper Wires
Breadboard
Optional: Resistors (10kΩ pull-down for buttons)
...
LCD D6	D6
LCD D7	D7
Push Button 1 (mode)	D8
Push Button 2 (increment)	D9
Push Button 3 (decrement)	D10
LCD VSS	GND
LCD VDD	5V
LCD V0 (Contrast)	Potentiometer center pin
LCD RW	GND
